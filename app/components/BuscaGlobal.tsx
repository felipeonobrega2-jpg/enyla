...
function Icone({ tipo, selected }: { tipo: string; selected: boolean }) {
  const cls = `w-3.5 h-3.5 ${selected ? "text-[#007AFF]" : "text-[#8E8E93]"}`
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center gap-3 px-4 py-2.5 text-left transition-colors ${
                          isSelected ? "bg-[#007AFF]/[0.06]" : "hover:bg-[rgba(0,0,0,0.02)]"
                        }`}
                      >
                        <div className={`w-7 h-7 rounded-lg flex items-center justify-center shrink-0 transition-colors ${
                          isSelected ? "bg-[#007AFF]/10" : "bg-[rgba(116,116,128,0.08)]"
                        }`}>
                        ...
                        {isSelected && (
                          <svg className="w-3.5 h-3.5 text-[#007AFF] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
